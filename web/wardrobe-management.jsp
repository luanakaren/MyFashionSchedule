    ...
    <div class="container content mgb20">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="category.jsp">Pull (5)</a></li>
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="#">MY SHOES</a></li>
                        <li><a href="category.jsp">Boots (3)</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="#">MY JEWELS</a></li>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="category.jsp">MY PERFUMES (4)</a></li>
                    </ul>
                </div>
            </div>
        </div>
