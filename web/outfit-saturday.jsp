            ...
            <div class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading typical-week">
                        <h4 class="panel-title" id="set-monday">Monday : Pants</h4>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading typical-week">
                        <h4 class="panel-title" id="set-thursday">Thursday : Dress</h4>
                    </div>
                </div>

                <div class="panel panel-default">
                    <div class="panel-heading typical-week">
                        <h4 class="panel-title" id="set-friday">Friday : Pants</h4>
                    </div>
                </div>

                <div class="panel panel-default">
                    <div class="panel-heading typical-week">
                        <h4 class="panel-title" id="set-saturday">Saturday : Casual</h4>
                    </div>
                </div>

                <div class="panel panel-default">
                    <div class="panel-heading typical-week">
                        <h4 class="panel-title" id="set-sunday">Sunday : Sporty</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(function() {
            ...
            function showEvents( contentEl, dateprop ) {
                ...
                var $events = $( '<div id="custom-content-reveal" class="custom-content-reveal"><h4>' + dateprop.day + ' '
                                + dateprop.monthname + ', ' + dateprop.year + ' : TRIP</h4></div>' ),
...
<jsp:include page="include/footer_outfit_saturday.jsp"></jsp:include>
