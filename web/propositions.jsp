...
<jsp:include page="include/header.jsp"></jsp:include>
    ...
    <section class="portfolio mgt20 content">
        <div class="container">
            <h3 class="description"><i class="fa fa-star-half-o"></i> Outfit's propositions for 17 September, 2016</h3>
            <div class="row mgt20">
                ...
                <ul class="portfolio-items list-unstyled" id="grid">
                    ...
                    <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12" data-groups='["everyday"]'>
                        <figure class="portfolio-item">
                            <div class="thumbnail propositions" >
                                <img src="assets/img/clothes/everyday5.png" class="img-responsive">
                                <div class="caption">
                                    <div class="row mgt20">
                                        <div class="col-md-10">
                    ...
                    <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12" data-groups='["trip"]'>
                        <figure class="portfolio-item">
                            <div class="thumbnail propositions" >
                                <img src="assets/img/clothes/trip5.png" class="img-responsive">
                                <div class="caption">
                                    <div class="row mgt20">
                                        <div class="col-md-10">
                                            Outftit composed by you
    ...
    <!--<div class="container content mgb20">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail" >
                    <img src="http://placehold.it/650x450&text=1st proposition" class="img-responsive">
                    <div class="caption">
                        <div class="row">
                            <div class="col-md-10">
                                <p>Top :</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail" >
                    <img src="http://placehold.it/650x450&text=2nd proposition" class="img-responsive">
                    <div class="caption">
                        <div class="row">
                            <div class="col-md-10">
                                <p>Top :</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail" >
                    <img src="http://placehold.it/650x450&text=3rd proposition" class="img-responsive">
                    <div class="caption">
                        <div class="row">
                            <div class="col-md-10">
                                <p>Top :</p>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail" >
                    <img src="http://placehold.it/650x450&text=4th proposition" class="img-responsive">
                    <div class="caption">
                        <div class="row">
                            <div class="col-md-10">
                                <p>Top :</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail" >
                    <img src="http://placehold.it/650x450&text=5th proposition" class="img-responsive">
                    <div class="caption">
                        <div class="row">
                            <div class="col-md-10">
                                <p>Top :</p>
